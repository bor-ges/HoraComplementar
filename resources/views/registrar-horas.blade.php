            ...
            <form action="{{route("atividades.store")}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="nome" id="activity_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ex: Palestra sobre IA" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input datepicker datepicker-autohide type="text" name="data_atividade" id="activity_date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Selecione a data">
                        </div>
                    </div>
                    <div>
                        <label for="total_hours" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Total de Horas</label>
                        <input type="number" name="horas_declaradas" id="total_hours" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ex: 40" required>
                    </div>
                </div>
                <div class="mb-6">
